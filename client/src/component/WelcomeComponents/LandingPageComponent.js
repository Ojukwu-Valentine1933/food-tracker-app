  ...
  return (
    <div>
        ...
        <div className={`bg-body-tertiary container  ${styles.hero_div}`}>
          <div className={`hero-intro container ${styles.hero_intro}`}>
            <div className={`${styles.hero_text}`}>
              <p style={{ fontSize: "14px" }} className={`${styles.order}`}>
          ...
          <div className="hero-img">
            <div className={`curved-div ${styles.curved_div}`}>
              <div className={`${styles.hero_img}`}>
                <img src={eatingLady} className={`${styles.eating_lady}`} alt="" />
              </div>
      ...
      <section className="container">
        ...
        <div className={`${styles.discountFood_div}`}>
          <div className={`row`}>
        ...
        <div className={`mt-5`}>
          ...
          <div>
            <div className={`row orderedFood_div ${styles.orderedFood_div}`}>
              <div
            ...
            <div className={`${styles.personalised_div}`}>
              ...
              <div className={`${styles.personalised}`}>
                ...
                <div>
                  <img
                    src={appDownload}
                    className={`${styles.dowloandIcons}`} alt=""
                  />
                </div>
              </div>
            </div>
      ...
      <section className={`container`}>
        <div className={` ${styles.chef_and_dispatch_div}`}>
          <div className={`${styles.chef}`}>
            <div className={``}>
              <p className={`${styles.dispatch_chef_text_one}`}>Earn more with lower fees</p>
              <div className={`${styles.dispatch_text_div}`}> 
              <p className={`${styles.dispatch_chef_text_two}`}>Signup as a business</p>
              <h1 className={`${styles.dispatch_chef_text_three}`}>Partner with us</h1>
              <button className={`${styles.dispatch_chef_text_btn}`}>Get Started</button>
              </div>
            </div>
          </div>
          ...
          <div className={`${styles.dispatchRider}`}>
            <div className={``}>
              <p className={`${styles.dispatch_chef_text_one}`}>Avail exclusive perks</p>
              <div className={`${styles.dispatch_text_div}`}> 
              <p className={`${styles.dispatch_chef_text_two}`}>Signup as a rider</p>
              <h1 className={`${styles.dispatch_chef_text_three}`}>Ride with us</h1>
              <button className={`${styles.dispatch_chef_text_btn}`}>Get Started</button>
              </div>
            </div>
          </div>
